          ...
          <div>
            ...
            <ol className="space-y-4 ml-5 list-decimal">
              {recipe.instructions?.map((step, index) => (
                ...
                <>
                  <li className="text-muted-foreground">Prepare all ingredients as listed.</li>
                  <li className="text-muted-foreground">Mix the ingredients in a large bowl.</li>
                  <li className="text-muted-foreground">Cook according to the specified temperature and time.</li>
                  <li className="text-muted-foreground">Serve hot and enjoy your meal!</li>
                </>
              )}
            </ol>
          </div>
          ...
          <div className="bg-muted p-6 rounded-lg">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>Calories</span>
                <span className="font-medium">{recipe.nutrition?.calories || "320"} kcal</span>
              </div>
              <Separator />
              <div className="flex justify-between text-sm">
                <span>Protein</span>
                <span className="font-medium">{recipe.nutrition?.protein || "15"}g</span>
              </div>
              <Separator />
              <div className="flex justify-between text-sm">
                <span>Carbohydrates</span>
                <span className="font-medium">{recipe.nutrition?.carbs || "40"}g</span>
              </div>
              <Separator />
              <div className="flex justify-between text-sm">
                <span>Fat</span>
                <span className="font-medium">{recipe.nutrition?.fat || "12"}g</span>
              </div>
            </div>
          </div>
        </div>
